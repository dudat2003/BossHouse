...
async function seed() {
  ...
  const prods = await product.insertMany([
    // Thức ăn cho chó
    {
      ...
      description:
        "Royal Canin Puppy - thức ăn dinh dưỡng cao cấp cho chó con dưới 12 tháng tuổi. Hỗ trợ phát triển xương, răng, tăng cường miễn dịch. Xuất xứ Pháp.",
      images: [
    ...
    },
    {
      ...
      description:
        "Pedigree Adult - thức ăn hoàn chỉnh cho chó trưởng thành, giàu protein từ thịt gà và rau củ. Giúp xương chắc khỏe, lông mượt.",
      images: [
        "https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=500",
      ],
      isActive: true,
    ...
    },
    {
      ...
      description:
        "Pate Whiskas vị cá ngừ & cá hồi, 400g - thức ăn mềm bổ sung đầy đủ vitamin, khoáng chất cho mèo. Dễ tiêu hóa, thơm ngon.",
      images: [
        "https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=500",
      ],
      isActive: true,
    ...
    },
    {
      ...
      description:
        "Me-O Adult - thức ăn khô cho mèo trưởng thành, giúp giảm mùi phân, tốt cho đường tiêu hóa. Vị cá biển thơm ngon.",
      images: [
        "https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=500",
      ],
      isActive: true,
    ...
    },
    {
      ...
      description:
        "Xương gặm Vegebrand Dental Care - giúp làm sạch răng, giảm cao răng, thơm miệng cho chó. Thành phần tự nhiên an toàn.",
      images: [
        "https://images.unsplash.com/photo-1625316708582-7c38734be31d?w=500",
      ],
      isActive: true,
      sizes: [
    ...
    // Phụ kiện cho chó
    {
      ...
      description:
        "Vòng cổ da bò thật 100%, bền chắc, thoáng khí. Khóa kim loại chống gỉ, có móc gắn dây dắt. Phù hợp chó trung bình đến lớn.",
      images: [
    ...
    },
    {
      ...
      description:
        "Lồng vận chuyển tiêu chuẩn hàng không IATA, nhựa ABS chắc chắn, có quạt thông gió, khay lót đáy tháo rời. An toàn khi di chuyển xa.",
      images: [
        "https://images.unsplash.com/photo-1544568104-5b7eb8189dd4?w=500",
      ],
      isActive: true,
      sizes: [
        {
    ...
    },
    {
      ...
      description:
        "Dây dắt chó dù bền chắc, tay cầm có đệm xốp êm tay, móc xoay 360° chống rối. Chiều dài 1.5m phù hợp dắt chó đi dạo.",
      images: [
        "https://images.unsplash.com/photo-1601758228041-f3b2795255f1?w=500",
      ],
      isActive: true,
    ...
    },
    {
      ...
      description:
        "Bát ăn, uống inox 304 không gỉ, giá đỡ gỗ cao cấp giúp chó ăn uống đúng tư thế, tốt cho cột sống. Dễ vệ sinh.",
      images: [
        "https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=500",
      ],
      isActive: true,
    ...
    },
    {
      ...
      description:
        "Khay vệ sinh mèo nhựa PP cao cấp, viền cao chống văng cát, có xẻng xúc kèm theo. Dễ lau chùi, không thấm mùi.",
      images: [
        "https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=500",
      ],
      isActive: true,
    ...
    },
    {
      ...
      description:
        "Nhà ngủ mèo dạng hang lông cừu, giữ ấm tốt, êm ái thoải mái. Có thể gấp gọn, dễ vệ sinh. Phù hợp mùa đông.",
      images: [
        "https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=500",
      ],
      isActive: true,
    ...
    // Vệ sinh & chăm sóc
    {
      ...
      description:
        "Cát vệ sinh Catsan Hygiene Plus, khử mùi hiệu quả, vón cục nhanh, không bụi, an toàn cho mèo và người. Dung tích 10L.",
      images: [
        "https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=500",
      ],
      isActive: true,
    ...
    },
    {
      ...
      description:
        "Sữa tắm Bio-Groom Protein-Lanolin, công thức dưỡng ẩm chuyên sâu, giúp lông mượt, óng ả, giảm rụng lông. pH cân bằng, không kích ứng da.",
      images: [
        "https://images.unsplash.com/photo-1600353983520-1f50a1a3c9f1?w=500",
      ],
      isActive: true,
      sizes: [
    ...
    },
    {
      ...
      description:
        "Lược chải lông tự động One Touch, loại bỏ lông rụng hiệu quả, nút nhả lông tiện lợi. Đầu lược tròn êm ái, massage da thú cưng.",
      images: [
        "https://images.unsplash.com/photo-1589924691995-400dc9ecc119?w=500",
      ],
      isActive: true,
    ...
    // Đồ chơi
    {
      ...
      description:
        "Bóng đồ chơi cao su tự nhiên có gai massage, giúp làm sạch răng, tăng cường sức khỏe nướu răng khi chó cắn. Có tiếng kêu thu hút.",
      images: [
    ...
    },
    {
      ...
      description:
        "Đồ chơi cần câu lông vũ đầu chuột, kích thích bản năng săn mồi của mèo. Thân cần carbon linh hoạt, có thể thay đầu đồ chơi.",
      images: [
    ...
    },
    {
      ...
      description:
        "Kong Classic - đồ chơi cao su tự nhiên nổi tiếng, có thể nhồi thức ăn bên trong, giúp chó giải trí, giảm stress khi ở nhà một mình.",
      images: [
        "https://images.unsplash.com/photo-1535930891776-0c2dfb7fda1a?w=500",
      ],
      isActive: true,
      sizes: [
  ...
  const roles = await role.insertMany([
    ...
    {
      role: "nhanvien",
      permissions: ["manageProducts", "manageOrders", "viewReports"],
    },
