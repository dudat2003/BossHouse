  ...
  return (
    <>
      <Form
        form={form}
        onFinish={onFinish}
        className="md:grid grid-cols-4 grid-rows-2 mt-10 bg-white gap-2 p-4 rounded-xl"
      >
          ...
          <div className="flex flex-col justify-center items-center ">
            ...
            <div className="mt-16 flex flex-col items-center">
              <label
                ...
                className="p-2 bg-slate-100 hover:bg-slate-200 text-sm font-medium rounded-md cursor-pointer"
              >
            ...
            <div className="flex mt-4 space-x-3 lg:mt-6">
              <span
                ...
                className="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 cursor-pointer"
              >
                Sửa thông tin
              </span>
              <span
                onClick={handleMessageClick}
                className="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-red-700 rounded-lg border border-gray-300 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 cursor-pointer"
              >
                Hủy sửa
              </span>
            </div>
